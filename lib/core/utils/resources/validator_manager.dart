...
class ValidatorManager {
  static String? firstName(String? value) {
    ...
    return StringManager.firstNameError;
    }
    return null;
  }
  ...
  static String? lastName(String? value) {
    ...
    return StringManager.lasrNameError;
    }
    return null;
  }
  ...
  static String? validateConfirmPassword(String? value,String? passwordvalue) {
    ...
    if (value != passwordvalue) {
      return StringManager.rePasswordNotFound;
    }
    return null;
  }
  ...
  static String? phoneNumber(String? value) {
    if (value == null || value.isEmpty) {
      return StringManager.enterYourConfirmPassword ;
    }
